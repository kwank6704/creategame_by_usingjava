...
public class ComputerCenter extends GameMap {
	...
	public ComputerCenter(Pane playerPane , ImageView playerImage) {
		super("ComputerCenter", "map_image/com_room.png", new Integer[] {260, 725, 15, 440});
		
		Player player = Player.getInstance();
		Image gandamImage = new Image("npc/gandam.png");
		ImageView npcImage = ImageUtils.createImageView(gandamImage, 72, 72); //location: 480,35
		...
		List<Actionable> actionables = Arrays.asList(
				...
				new ShowNPCAction(playerPane, npcImage,530,40),
	...
	public void wall() {
		...
		block(285, 480, 75, 310); //com left
		block(510, 670, 75, 310); //com left
		block(285, 670, 355, 405); //com btm
		block(225, 250, 10, 80); //stand
		block(505, 595, 30, 60); //teacher+table
	}
