...
public class MainApplication extends Application {
	...
	public void start(Stage primaryStage) {
		...
		StackPane genderSelectionPane = GenderSelectionPane.build(primaryStage);

		// Add Scene Changing Event to Created Pane
		startAddEvents(startPane, primaryStage);
		settingAddEvents(settingPane, primaryStage);
		genderAddEvents(genderSelectionPane, primaryStage);
	...
	private void startAddEvents(StackPane startPane, Stage primaryStage) {
	...
	private void settingAddEvents(StackPane settingPane, Stage primaryStage) {
	...
	private void genderAddEvents(StackPane genderSelectionPane, Stage primaryStage) {
